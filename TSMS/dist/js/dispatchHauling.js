...
// Isotope
  ...
  $('.btnTeamAssign').on('click',function() {
    $('.btnTeamAssign').addClass('font-weight-bold');
    $('.btnTugboatAssign').removeClass('font-weight-bold');
    $('.btnCreateSched').removeClass('font-weight-bold');
    $('.btnTeamAssign').addClass('active');
  ...
  $('.btnCreateSched').on('click',function() {
    $('.btnCreateSched').addClass('font-weight-bold');
    $('.btnTeamAssign').removeClass('font-weight-bold');
    $('.btnTugboatAssign').removeClass('font-weight-bold');
    $('.btnCreateSched').addClass('active');
    $('.btnTeamAssign').removeClass('active');
    $('.btnTugboatAssign').removeClass('active');
    $('.teamAssignment').css('display','none');
    $('.tugboatAssignment').css('display','none');
    $('.createSched').css('display','block');
  });
  $('.btnTugboatAssign').on('click',function() {
    $('.btnTugboatAssign').addClass('font-weight-bold');
    $('.btnCreateSched').removeClass('font-weight-bold');
    $('.btnTeamAssign').removeClass('font-weight-bold');
    $('.btnTugboatAssign').addClass('active');
    $('.btnCreateSched').removeClass('active');
    $('.btnTeamAssign').removeClass('active');
    $('.teamAssignment').css('display','none');
    $('.createSched').css('display','none');
