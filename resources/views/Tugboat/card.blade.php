    ...
    <div class="card animated bounceInLeft">
        ...
        <div class="card-body">
            <div id="smartwizard">
                ...
                <!-1-->
                <div>
                    {!! Form::open(['action' => 'TugboatController@store', 'method' => 'POST']) !!}
                        <div id="step-1" class="ml-3 mt-3 mr-3">
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            <img src="/others/stisla_admin_v1.0.0/dist/img/example-image.jpeg" class="img-thumbnail" id="AddfPic"><br><br>
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            <img src="/others/stisla_admin_v1.0.0/dist/img/example-image.jpeg" class="img-thumbnail" id="AddsPic"><br><br>
                                            <div class="custom-file">
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            <img src="/others/stisla_admin_v1.0.0/dist/img/example-image.jpeg" class="img-thumbnail" id="AddtPic"><br><br>
                                            <div class="custom-file">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <input id="AddLastDryDocked" class="form-control" placeholder="YYYY-MM-DD">
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="form-group">
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" id="AddCyl" name="AddCyl" placeholder="Cylinder">
                                                <div class="input-group-append">
                                                    <span class="input-group-text">/</span>
                                                </div>
                                                <input type="text" class="form-control" id="AddCircle" name="AddCircle" placeholder="Circle">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="AddInsurance1" name="AddInsurance1" placeholder="Tugboat Insurance # 1">
