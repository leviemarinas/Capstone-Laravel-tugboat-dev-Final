                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        {{Form::text('Surname','',['class'=>'form-control','id'=>'addPosition','placeholder' => 'Surname'])}}
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        {{Form::label('First Name','First Name')}}
                                        {{Form::text('FirstName','',['class'=>'form-control','id'=>'addPosition','placeholder' => 'First Name'])}}
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        {{Form::label('Middle Name','Middle Name')}}
                                        {{Form::text('Middle Name','',['class'=>'form-control','id'=>'addPosition','placeholder' => 'Middle Name'])}}
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
