                ...
                <ul class="sidebar-menu">
                    ...
                    <li id="maintenanceTree">
                        ...
                        <ul class="menu-dropdown">
                            <li id="berthMenu"><a href="/berth"><i class="fas fa-life-ring"></i>Berth</a></li>
                            <li id="employeesMenu"><a href="/employees"><i class="ion ion-person"></i> Employee</a></li>
                            <li id="equipmentsMenu"><a href="/equipment"><i class="fas fa-anchor"></i> Equipment</a></li>
                            <li id="pierMenu"><a href="/pier"><i class="fas fa-life-ring"></i> Pier</a></li>
                            <li id="positionMenu"><a href="/position"><i class="fas fa-sitemap"></i>Position</a></li>
                            <li id="tugboatMenu"><a href="/tugboat"><i class="ion ion-android-boat"></i> Tugboat</a></li>
                            <li id="usertypeMenu"><a href="/usertype"><i class="ion ion-person-stalker"></i> User Type</a></li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="menu-dropdown">
                            ...
                            <li id=""><a href="general.html"><i class="fas fa-ticket-alt"></i>Dispatch Ticket</a></li>
                            <li id=""><a href="components.html"><i class="ion ion-android-boat"></i>Dispatch &amp; Hauling</a></li>
                            <li id=""><a href="buttons.html"><i class="ion ion-ios-list"></i>Invoice</a></li>
                            <li id=""><a href="toastr.html"><i class="ion ion-clipboard"></i>Job Order</a></li>
                            <li id=""><a href="buttons.html"><i class="ion ion-cash"></i>Payment &amp; Billing</a></li>
                            <li id=""><a href="toastr.html"><i class="fas fa-calendar-alt"></i>Schedule</a></li>
                        </ul>
                    </li>
                    <li>
